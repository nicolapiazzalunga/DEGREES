...
def shortest_path(source, target):
    ...
    while True:
        ...
        # # If node is the goal, then we have a solution (Deprecated when Hint was implemented)
        ...
        # # Mark node as explored (Moved when Hint was implemented)
        ...
        for movie, person in neighbors:
            if not frontier.contains_state(person) and person not in explored:
                ...
                # Check if child is solution to improve effciency (As for Hint in Spec.)
                if child.state == target:
                    ...
                    solution.reverse()
                    return solution
                # If child is not solution add it to frontier
